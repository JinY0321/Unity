...
namespace Controller
{
    ...
    public class MovePlayerInput : MonoBehaviour
    {
        ...
        [SerializeField]
        private KeyCode m_RunKey = KeyCode.Z;
        [SerializeField]
        private KeyCode m_SlideKey = KeyCode.LeftShift;
        ...
        public void GatherInput()
        {
            ...
            m_IsSlide = Input.GetKey(m_SlideKey);
        ...
        public void SetInput()
        {
            if (m_Mover != null)
            {
                m_Mover.SetInput(in m_Axis, in m_Target, in m_IsRun, m_IsJump, m_IsSlide);
            }

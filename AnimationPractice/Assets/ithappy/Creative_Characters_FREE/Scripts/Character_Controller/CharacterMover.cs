...
namespace Controller
{
    ...
    public class CharacterMover : MonoBehaviour
    {
        ...
        [SerializeField]
        private string m_SlideID = "IsSlide";
        [SerializeField]
        ...
        private void Awake()
        {
            ...
            m_Animation = new AnimationHandler(m_Animator, m_HorizontalID,  m_VerticalID, m_StateID, m_JumpID, m_SlideID);
        }
        ...
        public void SetInput(in Vector2 axis, in Vector3 target, in bool isRun, in bool isJump, in bool isSlide)
        {
            m_Axis = axis;
            m_Target = target;
            m_IsRun = isRun;
        ...
        private class AnimationHandler
        {
            ...
            private readonly string m_SlideID;
            ...
            public AnimationHandler(Animator animator, string horizontalID, string verticalID, string stateID, string jumpID, string slideID)
            {
                m_Animator = animator;
